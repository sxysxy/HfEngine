...
class SceneSTG < Scene
	...
	def update_keypress
		call_handler(:cancel) if Controller.keyboard.is_triggled(DX::DIK_X) 
		call_handler(:confirm) if Controller.keyboard.is_triggled(DX::DIK_Z) || Controller.keyboard.is_triggled(DX::DIK_RETURN)
	end
end